...
public:
    ...
    bool IsRandomBotRaceAllowed(uint8 race) const;
    bool IsRandomBotClassAllowed(uint8 cls) const;
    bool IsRandomBotZoneAllowed(uint32 mapId, uint32 zoneId) const;
    ...
    std::string effectiveRandomBotMapsAsString;
    ...
    std::vector<uint32> effectiveRandomBotMaps;
    ...
    bool progressiveRandomBots, progressiveRandomBotsRestrictRaces, progressiveRandomBotsRestrictClasses;
    uint32 randomBotProgressionStage, randomBotProgressionMaxLevel;
