...
void WorldConfig::BuildConfigCache()
{
    ...
    SetConfigValue<uint32>(CONFIG_FAKE_QUEUE_MODE, "FakeQueue.Mode", 0);
    SetConfigValue<uint32>(CONFIG_FAKE_QUEUE_CHANCE, "FakeQueue.Chance", 50);
    SetConfigValue<uint32>(CONFIG_FAKE_QUEUE_DELAY, "FakeQueue.Delay", 60000);
    SetConfigValue<bool>(CONFIG_FAKE_QUEUE_APPLY_TO_SKIP_QUEUE, "FakeQueue.ApplyToSkipQueue", false);
